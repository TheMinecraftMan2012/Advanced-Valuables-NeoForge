...
{
    public static ResourceKey<EquipmentAsset> RED_SAPPHIRE_EQA = EquipmentAssets.createId("red_sapphire");
    public static ResourceKey<EquipmentAsset> BLUE_SAPPHIRE_EQA = EquipmentAssets.createId("blue_sapphire");
    public static ResourceKey<EquipmentAsset> GREEN_SAPPHIRE_EQA = EquipmentAssets.createId("green_sapphire");

    public static ResourceKey<EquipmentAsset> RED_GARNET_EQA = EquipmentAssets.createId("red_garnet");
    public static ResourceKey<EquipmentAsset> BLUE_GARNET_EQA = EquipmentAssets.createId("blue_garnet");
    public static ResourceKey<EquipmentAsset> PINK_GARNET_EQA = EquipmentAssets.createId("pink_garnet");
    public static ResourceKey<EquipmentAsset> YELLOW_GARNET_EQA = EquipmentAssets.createId("yellow_garnet");

    public static ResourceKey<EquipmentAsset> FUSION_GEM_EQA = EquipmentAssets.createId("fusion_gem");
    public static ResourceKey<EquipmentAsset> RUBY_EQA = EquipmentAssets.createId("ruby");
