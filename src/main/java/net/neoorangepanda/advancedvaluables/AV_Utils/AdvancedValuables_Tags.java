...
public class AdvancedValuables_Tags
{
    public static class Blocks
    {
        ...
        public static final TagKey<Block> AV_CRAFTERS = createTag("av_crafters");
    ...
    public static class Items
    {
        ...
        public static final TagKey<Item> SMELT_ITEMS = createTag("smelt_items");
        public static final TagKey<Item> RAW_ITEMS = createTag("raw_items");
        ...
        public static final TagKey<Item> AV_HELMETS = createTag("av_helmets");
        public static final TagKey<Item> AV_CHESTPLATES = createTag("av_chestplates");
        public static final TagKey<Item> AV_LEGGINGS = createTag("av_leggings");
        public static final TagKey<Item> AV_BOOTS = createTag("av_boots");
