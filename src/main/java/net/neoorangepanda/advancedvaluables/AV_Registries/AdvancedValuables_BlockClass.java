...
public class AdvancedValuables_BlockClass
{
    ...
    public static final DeferredBlock<StairBlock> RED_SAPPHIRE_STAIRS = registerBlock("red_sapphire_stairs",
            (properties) -> new StairBlock(RED_SAPPHIRE_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_stairs")))));

    public static final DeferredBlock<SlabBlock> RED_SAPPHIRE_SLAB = registerBlock("red_sapphire_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_slab")))));
    ...
    public static final DeferredBlock<PressurePlateBlock> RED_SAPPHIRE_PRESSURE_PLATE = registerBlock("red_sapphire_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> RED_SAPPHIRE_BUTTON = registerBlock("red_sapphire_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_button")))));

    public static final DeferredBlock<FenceBlock> RED_SAPPHIRE_FENCE = registerBlock("red_sapphire_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_fence")))));

    public static final DeferredBlock<FenceGateBlock> RED_SAPPHIRE_FENCE_GATE = registerBlock("red_sapphire_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_fence_gate")))));

    public static final DeferredBlock<WallBlock> RED_SAPPHIRE_WALL = registerBlock("red_sapphire_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_wall")))));

    public static final DeferredBlock<DoorBlock> RED_SAPPHIRE_DOOR = registerBlock("red_sapphire_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_door")))));

    public static final DeferredBlock<TrapDoorBlock> RED_SAPPHIRE_TRAPDOOR = registerBlock("red_sapphire_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_sapphire_trapdoor")))));

    // -- Blue Sapphire -- //
    public static final DeferredBlock<StairBlock> BLUE_SAPPHIRE_STAIRS = registerBlock("blue_sapphire_stairs",
            (properties) -> new StairBlock(BLUE_SAPPHIRE_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_stairs")))));

    public static final DeferredBlock<SlabBlock> BLUE_SAPPHIRE_SLAB = registerBlock("blue_sapphire_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_slab")))));
    ...
    public static final DeferredBlock<PressurePlateBlock> BLUE_SAPPHIRE_PRESSURE_PLATE = registerBlock("blue_sapphire_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> BLUE_SAPPHIRE_BUTTON = registerBlock("blue_sapphire_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_button")))));

    public static final DeferredBlock<FenceBlock> BLUE_SAPPHIRE_FENCE = registerBlock("blue_sapphire_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_fence")))));

    public static final DeferredBlock<FenceGateBlock> BLUE_SAPPHIRE_FENCE_GATE = registerBlock("blue_sapphire_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_fence_gate")))));

    public static final DeferredBlock<WallBlock> BLUE_SAPPHIRE_WALL = registerBlock("blue_sapphire_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_wall")))));

    public static final DeferredBlock<DoorBlock> BLUE_SAPPHIRE_DOOR = registerBlock("blue_sapphire_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_door")))));

    public static final DeferredBlock<TrapDoorBlock> BLUE_SAPPHIRE_TRAPDOOR = registerBlock("blue_sapphire_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_sapphire_trapdoor")))));

    // -- Green Sapphire -- //
    public static final DeferredBlock<StairBlock> GREEN_SAPPHIRE_STAIRS = registerBlock("green_sapphire_stairs",
            (properties) -> new StairBlock(GREEN_SAPPHIRE_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_stairs")))));

    public static final DeferredBlock<SlabBlock> GREEN_SAPPHIRE_SLAB = registerBlock("green_sapphire_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_slab")))));
    ...
    public static final DeferredBlock<PressurePlateBlock> GREEN_SAPPHIRE_PRESSURE_PLATE = registerBlock("green_sapphire_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> GREEN_SAPPHIRE_BUTTON = registerBlock("green_sapphire_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_button")))));

    public static final DeferredBlock<FenceBlock> GREEN_SAPPHIRE_FENCE = registerBlock("green_sapphire_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_fence")))));

    public static final DeferredBlock<FenceGateBlock> GREEN_SAPPHIRE_FENCE_GATE = registerBlock("green_sapphire_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_fence_gate")))));

    public static final DeferredBlock<WallBlock> GREEN_SAPPHIRE_WALL = registerBlock("green_sapphire_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_wall")))));

    public static final DeferredBlock<DoorBlock> GREEN_SAPPHIRE_DOOR = registerBlock("green_sapphire_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_door")))));

    public static final DeferredBlock<TrapDoorBlock> GREEN_SAPPHIRE_TRAPDOOR = registerBlock("green_sapphire_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "green_sapphire_trapdoor")))));

    // -- Red Garnet -- //
    public static final DeferredBlock<StairBlock> RED_GARNET_STAIRS = registerBlock("red_garnet_stairs",
            (properties) -> new StairBlock(RED_GARNET_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_stairs")))));

    public static final DeferredBlock<SlabBlock> RED_GARNET_SLAB = registerBlock("red_garnet_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_slab")))));

    public static final DeferredBlock<PressurePlateBlock> RED_GARNET_PRESSURE_PLATE = registerBlock("red_garnet_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> RED_GARNET_BUTTON = registerBlock("red_garnet_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_button")))));

    public static final DeferredBlock<FenceBlock> RED_GARNET_FENCE = registerBlock("red_garnet_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_fence")))));

    public static final DeferredBlock<FenceGateBlock> RED_GARNET_FENCE_GATE = registerBlock("red_garnet_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_fence_gate")))));

    public static final DeferredBlock<WallBlock> RED_GARNET_WALL = registerBlock("red_garnet_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_wall")))));

    public static final DeferredBlock<DoorBlock> RED_GARNET_DOOR = registerBlock("red_garnet_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_door")))));

    public static final DeferredBlock<TrapDoorBlock> RED_GARNET_TRAPDOOR = registerBlock("red_garnet_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "red_garnet_trapdoor")))));

    // -- Blue Garnet -- //
    public static final DeferredBlock<StairBlock> BLUE_GARNET_STAIRS = registerBlock("blue_garnet_stairs",
            (properties) -> new StairBlock(BLUE_GARNET_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_stairs")))));

    public static final DeferredBlock<SlabBlock> BLUE_GARNET_SLAB = registerBlock("blue_garnet_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_trapdoor")))));

    public static final DeferredBlock<PressurePlateBlock> BLUE_GARNET_PRESSURE_PLATE = registerBlock("blue_garnet_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> BLUE_GARNET_BUTTON = registerBlock("blue_garnet_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_button")))));

    public static final DeferredBlock<FenceBlock> BLUE_GARNET_FENCE = registerBlock("blue_garnet_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_fence")))));

    public static final DeferredBlock<FenceGateBlock> BLUE_GARNET_FENCE_GATE = registerBlock("blue_garnet_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_fence_gate")))));

    public static final DeferredBlock<WallBlock> BLUE_GARNET_WALL = registerBlock("blue_garnet_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_wall")))));

    public static final DeferredBlock<DoorBlock> BLUE_GARNET_DOOR = registerBlock("blue_garnet_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "blue_garnet_door")))));
    ...
    public static final DeferredBlock<StairBlock> PINK_GARNET_STAIRS = registerBlock("pink_garnet_stairs",
            (properties) -> new StairBlock(PINK_GARNET_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_stairs")))));

    public static final DeferredBlock<SlabBlock> PINK_GARNET_SLAB = registerBlock("pink_garnet_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_slab")))));

    public static final DeferredBlock<PressurePlateBlock> PINK_GARNET_PRESSURE_PLATE = registerBlock("pink_garnet_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> PINK_GARNET_BUTTON = registerBlock("pink_garnet_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_button")))));

    public static final DeferredBlock<FenceBlock> PINK_GARNET_FENCE = registerBlock("pink_garnet_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_fence")))));

    public static final DeferredBlock<FenceGateBlock> PINK_GARNET_FENCE_GATE = registerBlock("pink_garnet_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_fence_gate")))));

    public static final DeferredBlock<WallBlock> PINK_GARNET_WALL = registerBlock("pink_garnet_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_wall")))));

    public static final DeferredBlock<DoorBlock> PINK_GARNET_DOOR = registerBlock("pink_garnet_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_door")))));

    public static final DeferredBlock<TrapDoorBlock> PINK_GARNET_TRAPDOOR = registerBlock("pink_garnet_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "pink_garnet_trapdoor")))));

    // -- Yellow Garnet -- //
    public static final DeferredBlock<StairBlock> YELLOW_GARNET_STAIRS = registerBlock("yellow_garnet_stairs",
            (properties) -> new StairBlock(YELLOW_GARNET_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_stairs")))));

    public static final DeferredBlock<SlabBlock> YELLOW_GARNET_SLAB = registerBlock("yellow_garnet_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_slab")))));
    ...
    public static final DeferredBlock<PressurePlateBlock> YELLOW_GARNET_PRESSURE_PLATE = registerBlock("yellow_garnet_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> YELLOW_GARNET_BUTTON = registerBlock("yellow_garnet_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_button")))));

    public static final DeferredBlock<FenceBlock> YELLOW_GARNET_FENCE = registerBlock("yellow_garnet_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_fence")))));

    public static final DeferredBlock<FenceGateBlock> YELLOW_GARNET_FENCE_GATE = registerBlock("yellow_garnet_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_fence_gate")))));

    public static final DeferredBlock<WallBlock> YELLOW_GARNET_WALL = registerBlock("yellow_garnet_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_wall")))));

    public static final DeferredBlock<DoorBlock> YELLOW_GARNET_DOOR = registerBlock("yellow_garnet_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_door")))));

    public static final DeferredBlock<TrapDoorBlock> YELLOW_GARNET_TRAPDOOR = registerBlock("yellow_garnet_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "yellow_garnet_trapdoor")))));

    // -- Fusion Gem -- //
    public static final DeferredBlock<StairBlock> FUSION_STAIRS = registerBlock("fusion_stairs",
            (properties) -> new StairBlock(FUSION_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_stairs")))));

    public static final DeferredBlock<SlabBlock> FUSION_SLAB = registerBlock("fusion_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_slab")))));

    public static final DeferredBlock<PressurePlateBlock> FUSION_PRESSURE_PLATE = registerBlock("fusion_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> FUSION_BUTTON = registerBlock("fusion_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_button")))));

    public static final DeferredBlock<FenceBlock> FUSION_FENCE = registerBlock("fusion_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_fence")))));

    public static final DeferredBlock<FenceGateBlock> FUSION_FENCE_GATE = registerBlock("fusion_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_fence_gate")))));

    public static final DeferredBlock<WallBlock> FUSION_WALL = registerBlock("fusion_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_wall")))));

    public static final DeferredBlock<DoorBlock> FUSION_DOOR = registerBlock("fusion_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_door")))));

    public static final DeferredBlock<TrapDoorBlock> FUSION_TRAPDOOR = registerBlock("fusion_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "fusion_trapdoor")))));

    // -- Ruby -- //
    public static final DeferredBlock<StairBlock> RUBY_STAIRS = registerBlock("ruby_stairs",
            (properties) -> new StairBlock(RUBY_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_stairs")))));

    public static final DeferredBlock<SlabBlock> RUBY_SLAB = registerBlock("ruby_slab",
            (properties) -> new SlabBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_slab")))));

    public static final DeferredBlock<PressurePlateBlock> RUBY_PRESSURE_PLATE = registerBlock("ruby_pressure_plate",
            (properties) -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_pressure_plate")))));

    public static final DeferredBlock<ButtonBlock> RUBY_BUTTON = registerBlock("ruby_button",
            (properties) -> new ButtonBlock(BlockSetType.IRON, 10, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noCollission()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_button")))));

    public static final DeferredBlock<FenceBlock> RUBY_FENCE = registerBlock("ruby_fence",
            (properties) -> new FenceBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_fence")))));

    public static final DeferredBlock<FenceGateBlock> RUBY_FENCE_GATE = registerBlock("ruby_fence_gate",
            (properties) -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_fence_gate")))));

    public static final DeferredBlock<WallBlock> RUBY_WALL = registerBlock("ruby_wall",
            (properties) -> new WallBlock(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_wall")))));

    public static final DeferredBlock<DoorBlock> RUBY_DOOR = registerBlock("ruby_door",
            (properties) -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_door")))));

    public static final DeferredBlock<TrapDoorBlock> RUBY_TRAPDOOR = registerBlock("ruby_trapdoor",
            (properties) -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, "ruby_trapdoor")))));

    // -- Block Entities -- //
    public static final DeferredBlock<GemGrinderBlock> GEM_GRINDER = registerBlock("gem_grinder", GemGrinderBlock::new);
    public static final DeferredBlock<FusionGemStationBlock> FUSION_GEM_STATION = registerBlock("fusion_gem_station", FusionGemStationBlock::new);

    // -- Functions -- //

    private static DeferredBlock<Block> registerStoneOreBlock(String name, int minValue, int maxValue)
    {
        return registerBlock(name, (properties) -> new DropExperienceBlock(UniformInt.of(minValue, maxValue), BlockBehaviour.Properties.of()
                .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, name)))
                .strength(4f)
    ...
    {
        return registerBlock(name, (properties) -> new Block(BlockBehaviour.Properties.of()
                .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, name)))
                .strength(4f)
                .sound(soundType)
                .requiresCorrectToolForDrops()));
    ...
    {
        return registerFireResistantBlock(name, (properties) -> new Block(BlockBehaviour.Properties.of()
                .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, name)))
                .strength(4f)
                .sound(soundType)
                .requiresCorrectToolForDrops()));
