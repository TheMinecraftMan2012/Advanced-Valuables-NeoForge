...
{
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_RED_SAPPHIRE_ORE = registerKey("upper_red_sapphire_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_RED_SAPPHIRE_ORE = registerKey("medium_red_sapphire_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_RED_SAPPHIRE_ORE = registerKey("lower_red_sapphire_ore");

    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_BLUE_SAPPHIRE_ORE = registerKey("upper_blue_sapphire_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_BLUE_SAPPHIRE_ORE = registerKey("medium_blue_sapphire_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_BLUE_SAPPHIRE_ORE = registerKey("lower_blue_sapphire_ore");

    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_GREEN_SAPPHIRE_ORE = registerKey("upper_green_sapphire_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_GREEN_SAPPHIRE_ORE = registerKey("medium_green_sapphire_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_GREEN_SAPPHIRE_ORE = registerKey("lower_green_sapphire_ore");

    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_RED_GARNET_ORE = registerKey("upper_red_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_RED_GARNET_ORE = registerKey("medium_red_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_RED_GARNET_ORE = registerKey("lower_red_garnet_ore");

    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_BLUE_GARNET_ORE = registerKey("upper_blue_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_BLUE_GARNET_ORE = registerKey("medium_blue_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_BLUE_GARNET_ORE = registerKey("lower_blue_garnet_ore");

    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_PINK_GARNET_ORE = registerKey("upper_pink_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_PINK_GARNET_ORE = registerKey("medium_pink_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_PINK_GARNET_ORE = registerKey("lower_pink_garnet_ore");

    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_YELLOW_GARNET_ORE = registerKey("upper_yellow_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_YELLOW_GARNET_ORE = registerKey("medium_yellow_garnet_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_YELLOW_GARNET_ORE = registerKey("lower_yellow_garnet_ore");

    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> UPPER_RUBY_ORE = registerKey("upper_ruby_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> MEDIUM_RUBY_ORE = registerKey("medium_ruby_ore");
    public static final ResourceKey<@NotNull ConfiguredFeature<?, ?>> LOWER_RUBY_ORE = registerKey("lower_ruby_ore");
    ...
    public static ResourceKey<@NotNull ConfiguredFeature<?, ?>> registerKey(String name)
    {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, Identifier.fromNamespaceAndPath(AdvancedValuables.MOD_ID, name));
    }

    private static <FC extends FeatureConfiguration, F extends Feature<@NotNull FC>> void register(BootstrapContext<@NotNull ConfiguredFeature<?, ?>> context,
                                                                                                   ResourceKey<@NotNull ConfiguredFeature<?, ?>> key, F feature, FC configuration)
    {
