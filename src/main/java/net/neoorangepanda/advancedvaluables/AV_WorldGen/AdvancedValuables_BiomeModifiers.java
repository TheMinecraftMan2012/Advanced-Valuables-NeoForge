...
{
    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_RED_SAPPHIRE_ORE = registerKey("add_upper_red_sapphire_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_RED_SAPPHIRE_ORE = registerKey("add_medium_red_sapphire_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_RED_SAPPHIRE_ORE = registerKey("add_lower_red_sapphire_ore");

    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_BLUE_SAPPHIRE_ORE = registerKey("add_upper_blue_sapphire_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_BLUE_SAPPHIRE_ORE = registerKey("add_medium_blue_sapphire_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_BLUE_SAPPHIRE_ORE = registerKey("add_lower_blue_sapphire_ore");

    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_GREEN_SAPPHIRE_ORE = registerKey("add_upper_green_sapphire_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_GREEN_SAPPHIRE_ORE = registerKey("add_medium_green_sapphire_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_GREEN_SAPPHIRE_ORE = registerKey("add_lower_green_sapphire_ore");

    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_RED_GARNET_ORE = registerKey("add_upper_red_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_RED_GARNET_ORE = registerKey("add_medium_red_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_RED_GARNET_ORE = registerKey("add_lower_red_garnet_ore");

    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_BLUE_GARNET_ORE = registerKey("add_upper_blue_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_BLUE_GARNET_ORE = registerKey("add_medium_blue_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_BLUE_GARNET_ORE = registerKey("add_lower_blue_garnet_ore");

    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_PINK_GARNET_ORE = registerKey("add_upper_pink_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_PINK_GARNET_ORE = registerKey("add_medium_pink_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_PINK_GARNET_ORE = registerKey("add_lower_pink_garnet_ore");

    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_YELLOW_GARNET_ORE = registerKey("add_upper_yellow_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_YELLOW_GARNET_ORE = registerKey("add_medium_yellow_garnet_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_YELLOW_GARNET_ORE = registerKey("add_lower_yellow_garnet_ore");

    public static final ResourceKey<@NotNull BiomeModifier> ADD_UPPER_RUBY_ORE = registerKey("add_upper_ruby_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_MEDIUM_RUBY_ORE = registerKey("add_medium_ruby_ore");
    public static final ResourceKey<@NotNull BiomeModifier> ADD_LOWER_RUBY_ORE = registerKey("add_lower_ruby_ore");
