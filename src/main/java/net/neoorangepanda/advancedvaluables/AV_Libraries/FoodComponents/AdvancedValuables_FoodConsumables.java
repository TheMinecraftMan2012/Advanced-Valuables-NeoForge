package net.neoorangepanda.advancedvaluables.AV_Libraries.FoodComponents;
...
public class AdvancedValuables_FoodConsumables
{
    ...
    public static final Consumable ILLEGAL_FOOD = Consumable.builder().onConsume(new ApplyStatusEffectsConsumeEffect(
            List.of(
