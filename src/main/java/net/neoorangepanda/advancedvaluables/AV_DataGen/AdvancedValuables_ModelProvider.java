...
public class AdvancedValuables_ModelProvider extends ModelProvider
{
    ...
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels)
    {
        ...
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.RED_SAPPHIRE_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.BLUE_SAPPHIRE_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.GREEN_SAPPHIRE_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.RED_GARNET_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.BLUE_GARNET_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.PINK_GARNET_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.YELLOW_GARNET_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.MIXED_GARNET_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.MIXED_SAPPHIRE_POWDER.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(AdvancedValuables_ItemClass.RUBY_POWDER.get(), ModelTemplates.FLAT_ITEM);
