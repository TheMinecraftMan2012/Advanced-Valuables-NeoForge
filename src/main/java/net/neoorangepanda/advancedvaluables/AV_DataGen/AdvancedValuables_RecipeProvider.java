...
public class AdvancedValuables_RecipeProvider extends RecipeProvider
{
    ...
    protected void buildRecipes()
    {
        ...
        ShapelessRecipeBuilder.shapeless(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, AdvancedValuables_ItemClass.MIXED_SAPPHIRE_POWDER)
                ...
                .unlockedBy("has_red_sapphire", this.has(AdvancedValuables_ItemClass.RED_SAPPHIRE))
                .unlockedBy("has_blue_sapphire", this.has(AdvancedValuables_ItemClass.BLUE_SAPPHIRE))
        ...
        ShapelessRecipeBuilder.shapeless(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, AdvancedValuables_ItemClass.MIXED_GARNET_POWDER)
                ...
                .requires(AdvancedValuables_ItemClass.YELLOW_GARNET_POWDER)
                .unlockedBy("has_red_garnet", this.has(AdvancedValuables_ItemClass.RED_GARNET))
                .unlockedBy("has_blue_garnet", this.has(AdvancedValuables_ItemClass.BLUE_GARNET))
                .unlockedBy("has_pink_garnet", this.has(AdvancedValuables_ItemClass.PINK_GARNET))
