package net.neoorangepanda.advancedvaluables.AV_CMT;
...
public class AdvancedValuables_CreativeModeTabs
{
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> AV_CRAFTING_TAB = AV_REGISTER_CMT.register("crafting", () -> CreativeModeTab.builder()
            ...
            .displayItems((params, output) -> {
                output.accept(AdvancedValuables_ItemClass.RED_SAPPHIRE_POWDER);
                output.accept(AdvancedValuables_ItemClass.BLUE_SAPPHIRE_POWDER);
                output.accept(AdvancedValuables_ItemClass.GREEN_SAPPHIRE_POWDER);
                output.accept(AdvancedValuables_ItemClass.MIXED_SAPPHIRE_POWDER);

                output.accept(AdvancedValuables_ItemClass.RED_GARNET_POWDER);
                output.accept(AdvancedValuables_ItemClass.BLUE_GARNET_POWDER);
                output.accept(AdvancedValuables_ItemClass.PINK_GARNET_POWDER);
                output.accept(AdvancedValuables_ItemClass.YELLOW_GARNET_POWDER);
                output.accept(AdvancedValuables_ItemClass.MIXED_GARNET_POWDER);

                output.accept(AdvancedValuables_ItemClass.RUBY_POWDER);

                output.accept(AdvancedValuables_BlockClass.GEM_GRINDER);
                output.accept(AdvancedValuables_BlockClass.FUSION_GEM_STATION);
            })
            .build());
